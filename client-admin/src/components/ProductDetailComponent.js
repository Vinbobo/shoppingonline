...
class ProductDetail extends Component {
        ...
        <form>
          <table>
            <tbody>
              ...
              <tr>
                <td colSpan="2">{this.state.imgDetails.map((image,index)=>(<img key={index} src={image} width="100px" height="100px" alt="" />))}</td>
              </tr>
            </tbody>
          </table>
        </form>
  ...
  btnUpdateClick(e) {
    ...
    if (id && name && price && category && image) {
      ...
      alert('Please input id and name and price and category and image details');
    }
  }
  btnDeleteClick(e) {
    e.preventDefault();
